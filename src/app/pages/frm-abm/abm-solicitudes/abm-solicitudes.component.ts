...
@Component({
  selector: 'app-abm-solicitudes',
  templateUrl: './abm-solicitudes.component.html',
  styleUrls: ['./abm-solicitudes.component.scss']
})
export class AbmSolicitudesComponent implements OnInit {
      ...
      try {
        ...
        if (result.code === '200') {
          ...
          if (this.item.fechaSolicitud !== undefined) {
            this.item.fechaSolicitud = moment(this.item.fechaSolicitud).isValid()
