...
@Component({
  selector: 'app-fil-solicitud-reclamo',
  templateUrl: './fil-solicitud-reclamo.component.html',
  styleUrls: ['./fil-solicitud-reclamo.component.scss'],
})
export class FilSolicitudReclamoComponent implements OnInit {
  @Output() emmit: EventEmitter<SolicitudReclamo[]> = new EventEmitter();
  ...
  constructor(private wsdl: SolicitudReclamoService) {
    this.busqueda = '';
    this.items = [];
