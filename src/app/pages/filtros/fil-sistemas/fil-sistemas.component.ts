...
@Component({
  selector: 'app-fil-sistemas',
  templateUrl: './fil-sistemas.component.html',
  styleUrls: ['./fil-sistemas.component.scss']
})
export class FilSistemasComponent implements OnInit {

 @Output() emmit: EventEmitter<Sistemas[]> = new EventEmitter();
   ...
   constructor(private wsdl: SistemasService) {
     this.busqueda = '';
     this.items = [];
