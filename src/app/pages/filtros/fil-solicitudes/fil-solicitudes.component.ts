...
@Component({
  selector: 'app-fil-solicitudes',
  templateUrl: './fil-solicitudes.component.html',
  styleUrls: ['./fil-solicitudes.component.scss']
})
export class FilSolicitudesComponent implements OnInit {
  ...
  @Output() emmit: EventEmitter<SolicitudSistemas[]> = new EventEmitter();
   ...
   constructor(private wsdl: SolicitudesService) {
     this.busqueda = '';
     this.items = [];
