...
@Component({
  selector: 'app-fil-equipamientos',
  templateUrl: './fil-equipamientos.component.html',
  styleUrls: ['./fil-equipamientos.component.scss'],
})
export class FilEquipamientosComponent implements OnInit {
  @Output() emmit: EventEmitter<EquipamientoDTO[]> = new EventEmitter();
  ...
  constructor(private wsdl: EquipamientoService) {
    this.busqueda = '';
    this.items = [];
