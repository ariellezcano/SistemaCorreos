...
@Component({
  selector: 'app-fil-mantenimiento',
  templateUrl: './fil-mantenimiento.component.html',
  styleUrls: ['./fil-mantenimiento.component.scss']
})
export class FilMantenimientoComponent implements OnInit {

   @Output() emmit: EventEmitter<MantenimientoDTO[]> = new EventEmitter();
    ...
    constructor(private wsdl: MantenimientoService) {
      this.busqueda = '';
      this.items = [];
