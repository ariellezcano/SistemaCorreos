...
@Component({
  selector: 'app-fil-proveedor',
  templateUrl: './fil-proveedor.component.html',
  styleUrls: ['./fil-proveedor.component.scss'],
})
export class FilProveedorComponent implements OnInit {
  @Output() emmit: EventEmitter<Proveedor[]> = new EventEmitter();
