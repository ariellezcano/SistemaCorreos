...
export class DetalleCorreoService {
  api: string;

  constructor(private http: HttpClient) {
    this.api = environment.URL + 'DetalleCorreo_';
  }
  ...
  generarActa(item: UsuarioCorreoDto) {
    return this.http.post(`${this.api}/Reportes/ActaCorreo`, item, {
      responseType: 'blob',
    });
  }
}
